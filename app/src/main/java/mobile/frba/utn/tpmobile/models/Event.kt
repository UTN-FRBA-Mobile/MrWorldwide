 ...
 */
abstract class Event(val eventType: EventType,open var mg: Int, open var geoLocation: LatLng?,open var id : Int?,open var userId : String?, open var tripId : Int?, open var date : DateTime, open var title:String) {
